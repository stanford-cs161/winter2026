...
\subsection {Fourth part \Points {2}} Based on your results from $3.3$, how could Lucky combine algorithms (a) and (b) to create a more efficient algorithm? 
...
\textbf {[Hint:} Let $x = a \cdot 10^{n/2} + b$ and $y = c \cdot 10^{n/2} + d$ for some $n/2$-digit numbers $a$, $b$, $c$, $d$. Can you find a way to rewrite $x\star y$ in terms of $(a+b)$, $(c+d)$, $(a\star c)$, and $(b\star d)$?\textbf {]} 

\Expecting {An expansion of $x\star y$ in terms of $(a+b)$, $(c+d)$, $(a\star c)$, and $(b\star d)$, pseudocode for your algorithm, and a clear English description of what your algorithm is doing. You do not need to prove that your algorithm is correct.} 
